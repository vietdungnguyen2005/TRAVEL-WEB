...
"[project]/apps/web/src/app/(admin)/admin/rooms/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function RoomsManagement() {
    ...
    async function fetchRooms() {
        try {
            setLoading(true);
            const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gateway$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["gatewayFetch"])("/api/admin/rooms", {
                method: "GET",
    ...
    async function fetchRoomTypes() {
        try {
            const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gateway$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["gatewayFetch"])("/api/admin/room-types", {
                method: "GET",
                attachAccessToken: true
            });
            if (response.ok) {
...
_s(RoomsManagement, "5ttL8QVc8SUkD9VWpMXzhdRZA58=");
_c = RoomsManagement;
var _c;
__turbopack_context__.k.register(_c, "RoomsManagement");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=apps_web_src_abcc1ac4._.js.map