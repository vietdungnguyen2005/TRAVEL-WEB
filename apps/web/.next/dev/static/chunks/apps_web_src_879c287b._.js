...
"[project]/apps/web/src/app/(auth)/auth/forgot-password/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function ForgotPasswordPage() {
    ...
    const handleSubmit = async (e)=>{
        e.preventDefault();
        if (!email) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Vui lòng nhập email");
            return;
        }
        setIsLoading(true);
        try {
            const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gateway$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["gatewayFetch"])("/api/auth/forgot-password", {
                method: "POST",
                body: JSON.stringify({
                    email
                })
            ...
            setIsSuccess(true);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success("Email đặt lại mật khẩu đã được gửi!");
        } catch (error) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error(error.message || "Có lỗi xảy ra, vui lòng thử lại");
        } finally{
            setIsLoading(false);
        }
    };
...
_s(ForgotPasswordPage, "YHmUKLAXPV03E/iGLBy4nBW0KfI=");
...
//# sourceMappingURL=apps_web_src_879c287b._.js.map