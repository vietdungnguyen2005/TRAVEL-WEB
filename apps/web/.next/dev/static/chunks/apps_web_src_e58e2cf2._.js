...
function AdminBlogPage() {
    ...
    async function fetchPosts() {
        try {
            setLoading(true);
            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gateway$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["gatewayFetch"])("/api/admin/blog/posts", {
                method: "GET",
    ...
    async function save() {
        try {
            ...
            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gateway$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["gatewayFetch"])(url, {
                method,
                attachAccessToken: true,
                body: JSON.stringify({
                    ...form,
    ...
    async function remove(id) {
        ...
        if (!ok) return;
        try {
            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gateway$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["gatewayFetch"])(`/api/admin/blog/posts/${id}`, {
                method: "DELETE",
                attachAccessToken: true
            });
            if (!res.ok) {
...
_s(AdminBlogPage, "VcJ1C0GRtAsu1Xdicr5qyJBQ9KU=");
_c = AdminBlogPage;
var _c;
...
//# sourceMappingURL=apps_web_src_e58e2cf2._.js.map