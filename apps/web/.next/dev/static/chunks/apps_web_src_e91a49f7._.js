...
"[project]/apps/web/src/app/(auth)/auth/register/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function RegisterPage() {
    ...
    const handleSubmit = async (e)=>{
        ...
        if (data.password !== data.confirmPassword) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Lỗi xác thực", {
        ...
        if (data.password.length < 6) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Mật khẩu yếu", {
        ...
        try {
            const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gateway$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["gatewayFetch"])("/api/auth/register", {
                method: "POST",
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Đăng ký thất bại", {
                description: message
            });
        } finally{
            setLoading(false);
...
//# sourceMappingURL=apps_web_src_e91a49f7._.js.map