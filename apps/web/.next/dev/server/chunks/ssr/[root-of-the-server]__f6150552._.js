...
"[project]/apps/web/src/app/(auth)/auth/login/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function LoginPage() {
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gateway$2d$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["gatewayFetch"])("/api/auth/login", {
                method: "POST",
                body: JSON.stringify({
                    email,
                    password
            ...
            if (!res.ok) {
                if (res.status === 403 && data?.code === "EMAIL_NOT_VERIFIED") {
                    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error("Chưa xác thực email", {
                        description: data?.message || "Vui lòng xác thực email để đăng nhập"
                    });
                    return;
                }
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error("Đăng nhập thất bại", {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error("Lỗi hệ thống", {
    ...
    const handleGoogleSignIn = async ()=>{
        ...
        window.location.href = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gateway$2d$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["gatewayUrl"])(`/api/auth/oauth/google${params.toString() ? `?${params.toString()}` : ""}`);
    };
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f6150552._.js.map