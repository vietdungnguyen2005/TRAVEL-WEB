import { calculateTotalPriceCompat as calculateTotalPrice, isDateRangeAvailable } from '../booking-utils';
...
describe('booking-utils', () => {
  describe('calculateTotalPrice', () => {
    it('should calculate basic price without seasonal pricing', () => {
      ...
      const seasonalPrices: Array<{ startDate: Date; endDate: Date; pricePerNight: number }> = [];
  ...
  describe('isDateRangeAvailable', () => {
    it('should return true for available dates', () => {
      ...
      const bookings: Array<{ checkIn: Date; checkOut: Date }> = [];
