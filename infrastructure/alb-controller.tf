...
# ============================================================================
# Architecture role:
#   Internet → ALB (Public Subnets) → Nginx Ingress (pods) → app services
# The controller watches Ingress resources and creates AWS ALBs automatically.
# Uses IRSA to get the required IAM permissions.
# ============================================================================

# ---------------------------------------------------------------------------
# IAM Role (IRSA) for the LB Controller
# ---------------------------------------------------------------------------
...
# The official AWS LB Controller IAM policy
