...
export async function PUT(request, { params }) {
    try {
        ...
        return NextResponse.json({ error: "Failed to update room type", message: error.message }, { status: 500 });
    }
}
// DELETE room type
export async function DELETE(request, { params }) {
    try {
        ...
        return NextResponse.json({ error: "Failed to delete room type", message: error.message }, { status: 500 });
    }
}
