...
async function consulRegisterService(opts) {
    ...
    await axios_1.default.put(`${consulUrl}/v1/agent/service/register`, payload, { timeout: 4_000 });
...
async function consulDeregisterService(serviceId, consulUrl) {
    ...
    await axios_1.default.put(`${base}/v1/agent/service/deregister/${encodeURIComponent(serviceId)}`, null, { timeout: 4_000 });
